    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                addUser();
                if (user.getRole().equalsIgnoreCase("user")) {
                    if (supervisorName.getText().toString().isEmpty() || supervisorName.getText().toString().length() == 0) {
                    ...
                    if (etName.getText().toString().isEmpty() || etName.getText().toString().length() == 0) {
                        CustomSnackbar.createSnackbarRed("Please enter name", parent, AddUserActivity.this);

                    } else if (etEmail.getText().toString().isEmpty() || etEmail.getText().toString().length() == 0) {
                        CustomSnackbar.createSnackbarRed("Please enter email id", parent, AddUserActivity.this);
